// Str9.js - с переключением языка и модальными окнами
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Страница загружена, перевод и модальные окна работают');
